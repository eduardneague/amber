            ...
            <div className = {` ${show ? 'nav-black' : 'nav-wrapper'} w-full h-24 fixed top-0 z-[100]`}>
                <div className="nav-content flex justify-between items-center w-full h-full">
                    <motion.img
                        ...
                        className = "mt-2 nav-logo aspect-square h-24 ml-[2.25rem] cursor-pointer object-contain"
                    ...
                    <motion.img 
                        ...
                        animate = {{x: 0, opacity: 1}}
                        transition = {{ease: "easeOut", duration: 1}}
                        className = "nav-avatar cursor-pointer aspect-square h-10 mr-[2.25rem] object-contain"
